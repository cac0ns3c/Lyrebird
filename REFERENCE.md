...
| Telnet Brute-Force By Sample (IoT/Mirai Credential Guessing) | `telnet` | `tags=telnet-bruteforce` | medium |
| Second-Stage Payload Pull Over Telnet Shell (IoT Loader) | `telnet` | `tags=telnet-payload-pull` | high |
